-- STEP 1: INITIAL COMMANDS TO SET UP BACKEND
...
-- OPTIONAL STEP 1.2: RUN A TEST TO CHECK IF FUNCTION WORKS
...
-- STEP 3: SUSPEND REFRESH FIRST BEFORE RUNNING CODE BELOW
...
-- CHECK TABLE CONTENTS (DO NOT RUN UNLESS NEEDED)
SELECT * 
FROM PDF_RESULTS; 
